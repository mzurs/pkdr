...
export interface TopUpInterface extends utils.Interface {
  functions: {
    "TOPUP_AMOUNT()": FunctionFragment;
    "getContractBalance()": FunctionFragment;
    "getPkdrAddress()": FunctionFragment;
    "topUpAddress(address)": FunctionFragment;
...
export interface TopUp extends BaseContract {
  ...
  functions: {
    TOPUP_AMOUNT(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    TOPUP_AMOUNT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
